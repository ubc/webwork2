...
sub getDefList {
	...
	#
	# While follow was previously enabled in order to look into OPL symlinks,
	# it looks like they've optimized it now so that OPL is loaded from
	# pre-generated OPL def files instead. So we have even less reason to
	# re-enable this and risk slowing down the homework sets editor.
	#
