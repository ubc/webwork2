...
use WeBWorK::Utils qw(jitar_id_to_seq wwRound grade_set format_set_name_display writeLog);
...
sub displaySets {
	...
	push( @columnHeaders2, CGI::a({"href"=>$self->systemLink($setStatsPage,params=>{primary_sort=>'num_of_attempts', %params})},$r->maketext('# of Attempts')) );
